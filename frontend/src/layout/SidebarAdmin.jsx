...
const itemActive =
  "bg-rose-50 text-rose-700 shadow-[0_10px_30px_-12px_rgba(244,63,94,0.35)]";
const itemInactive =
  ...
  return (
    <aside className="flex h-full flex-col bg-white lg:h-full">
      <div className="relative flex-shrink-0 overflow-hidden px-4 pb-2 pt-2">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-rose-700/95 via-rose-600/85 to-rose-500/75" />
        <div className="relative rounded-3xl border border-white/15 bg-white/10 p-4 text-white shadow-[0_20px_45px_rgba(15,23,42,0.25)] backdrop-blur">
          ...
          <p className="mt-2 text-sm text-white/80">
            Oversee platform operations, team members, and performance indicators.
          </p>
        </div>
      </div>
